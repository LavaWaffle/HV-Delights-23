          ...
          <div className="flex flex-col-reverse items-center sm:flex-row justify-around">
            ...
            <div className="mt-[1rem] sm:mt-0">
              ...
              <div className="flex relative justify-end items-center gap-8">
                ...
                <button className={`${styles.textShadow} font-Piazzolla text-3xl sm:text-4xl md-5xl p-3 ${styles.rippleBgCustom} text-[#F47C7C] ${styles.dropShadowButton}`} onClick={() => setOpened(true)}>
                  SHOP
                </button>
              </div>
            </div>
