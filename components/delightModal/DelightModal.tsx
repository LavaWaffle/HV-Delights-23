...
import DelightModalR from './DelightModalR';
    ...
    <>
      ...
      <div className="h-screen w-screen fixed z-[150]">
        <div className="opacity-30">
          <button
            className="animate-fade-in absolute top-[-100px] w-full h-full bg-[#DFDFDF] "
            onClick={handleClose}
          ></button>
        </div>
      </div>
            ...
            <div className="flex flex-row justify-between">
              ...
              <div className="flex flex-col w-[60%] gap-8">
                <div className="flex flex-col text-white gap-4">
                  <div className="font-Inter font-semibold text-2xl">{props.title}</div>
                ...
                <div className="flex flex-col gap-10">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="text-[#FAFAFA] font-Rubik font-medium   ">Product Facts:</div>
              ...
              <div className="flex flex-col gap-7 w-[33%] justify-center">
                <div className="flex flex-col gap-2">
                  <div className="flex flex-col gap-5 pt-10">
                    <div className="font-Rubik font-medium text-xl text-[#FAFAFA]">Quantity</div>
                    <div className="flex flex-row items-center gap-5">
                      <button
                        className="bg-[#F49595] rounded-lg text-white text-3xl font-Inter font-light w-[3rem] h-[3.5rem] flex justify-center items-center pb-1"
                        onClick={handleRemove}
                      >
                        -
                      </button>
                      <div className="text-white font-Lato text-lg pb-1">{quantity}</div>
                      <button
                        className="bg-[#F49595] rounded-lg text-white text-3xl font-Inter font-light w-[3rem] h-[3.5rem] flex justify-center items-center pb-1"
                        onClick={handleAdd}
                      >
                ...
                <div className="flex flex-col gap-2">
                  <button
                    className="bg-[#FF8B8B] rounded-lg text-white text-base tracking-[.10em] font-Rubik font-medium uppercase w-full py-5 flex justify-center items-center"
                    onClick={handleAddToCart}
                  >
                    Add to Cart
                  </button>
                  <div className="font-Lato font-medium text-[#F5F5F5] text-xs">
                    Free U.S. shipping for orders over $20, and a risk-free{' '}
                    <span className="underline underline-offset-4">quality guarantee!</span>
                  </div>
                </div>
              </div>
            </div>
