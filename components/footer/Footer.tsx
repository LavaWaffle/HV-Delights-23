	...
	return (
		<section className="bg-[#F3CABD] border-t-[20px] border-[#F5C4B9] relative">
			<WidthLimiter paddingAll={true} customPadding={false}>
				{/* flex */}
				<div className="flex-col-reverse flex sm:flex-row item-center justify-around sm:px-0 sm:mt-0 sm:mb-6 md:mb-20 z-50">
					{/* left (words) */}
					<div className="flex flex-col space-y-16 z-50"> 
					...
					{/* right (form) */}
					<div className="w-[100%] sm:w-[40%] md:w-[42%] lg:w-[40%] desk:w-[30%] flex flex-col h-full justify-center gap-12 ml-3 z-50">
